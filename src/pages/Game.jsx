...
function Game() {
    ...
    return (
        <div className="font-inter">
            ...
            <main className="bg-light-green w-[max(100%,9.7rem)] h-[max(93.208vh,34rem)] pt-10 pl-5">
                <section className="inline-block w-[18vw] mr-[2vw]">
                    <div className="flex items-center justify-center h-[42.28vh] bg-light-green-500">
                        <p className="font-extralight px-4 text-white text-[2.5vw]">Tela Do Jogo</p>
                    </div>
                    <div className="text-light-green-500 uppercase font-normal">
                ...
                <section className="inline-block align-top w-[78.6vw] text-light-green-500">
                    <header className="uppercase">
                        <h1 className="font-normal border-b-4 border-light-green-500 pb-1">Título do jogo</h1>
